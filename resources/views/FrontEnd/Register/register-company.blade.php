                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store-company') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="last_name" class="col-md-4 col-form-label text-md-right">{{ __('Business Name') }}<span style="color: red">*</span></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="last_name" class="col-md-4 col-form-label text-md-right">{{ __('Company Logo') }}</label>
                                <div class="col-md-6">
                                    <input id="company_logo" type="file" class="form-control @error('company_logo') is-invalid @enderror" name="company_logo" accept="image/*">
                                    @error('company_logo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
